...
internal val InfraMapCanvasBg = Color(0xFF121214) // Deep Charcoal Black
internal val InfraMapSurfaceBg = Color(0xFF18181b) // Container Surface
internal val InfraMapSurfaceElevated = Color(0xFF27272a) // Elevated Surfaces & Borders
internal val InfraMapTextPrimary = Color(0xFFf4f4f5) // High-contrast body & header text
internal val InfraMapTextSecondary = Color(0xFFa1a1aa) // Subtitles & Icons

internal val InfraMapElectricViolet = Color(0xFF8b5cf6) // Primary / Active Accent (#8b5cf6)
internal val InfraMapEmeraldGreen = Color(0xFF10b981) // Secondary / Status Online (#10b981)
internal val InfraMapAmberWarm = Color(0xFFf59e0b) // Tertiary / Status Warning (#f59e0b)
internal val InfraMapRubyRed = Color(0xFFef4444) // Error / Status Offline (#ef4444)
