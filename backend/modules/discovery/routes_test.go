...
func TestRegisterRoutes(t *testing.T) {
	...
	testCases := []struct {
		...
		{"PUT", "/api/v1/discovery/sources/11111111-1111-1111-1111-111111111111"},
		{"POST", "/api/v1/discovery/sources/11111111-1111-1111-1111-111111111111/health"},
		{"GET", "/api/v1/discovery/sources/11111111-1111-1111-1111-111111111111/deletion-impact"},
